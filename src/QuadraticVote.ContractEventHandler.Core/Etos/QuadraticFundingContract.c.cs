...
namespace AElf.Contracts.QuadraticFunding {
  ...
  public partial class SupportUpdated : aelf::IEvent<SupportUpdated>
  {
    public global::System.Collections.Generic.IEnumerable<SupportUpdated> GetIndexed()
    {
      return new List<SupportUpdated>
      {
      };
    }

    public SupportUpdated GetNonIndexed()
    {
      return new SupportUpdated
      {
        Support = Support,
        Round = Round,
      };
  ...
  public partial class RoundStarted : aelf::IEvent<RoundStarted>
  {
    public global::System.Collections.Generic.IEnumerable<RoundStarted> GetIndexed()
    {
      return new List<RoundStarted>
      {
      };
    }

    public RoundStarted GetNonIndexed()
    {
